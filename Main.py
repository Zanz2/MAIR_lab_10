...
for full_sentance in training_array:
    corpus.append(full_sentance[1]) # This will make an array with just sentances, no predicted classes

vectorized_training_data = vectorizer.fit_transform(corpus)
bigram_vectorized_training_data = vectorizer.fit_transform(corpus)
...
#print(test_array)
#print(vectorized_training_data.toarray())
...
def decision_tree(dataset = None): #https://scikit-learn.org/stable/modules/tree.html
    test = 0
